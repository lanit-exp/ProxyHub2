...
public class ProxyRestController {
    ...
    public ResponseEntity<?> proxyIdRequest(@PathVariable String id, HttpServletRequest request) {
    ...
    public ResponseEntity<?> proxyNewSessionRequest(@PathVariable String tag, HttpServletRequest request) {
    ...
    public ResponseEntity<?> proxyQuitSessionRequest(@PathVariable String sessionId, HttpServletRequest request) {
        return mainProxyService.quitSessionRequestHandler(sessionId, request);
    }

    @RequestMapping(value = {"/proxy/tag/{tag}/session/{sessionId}/**"})
    public ResponseEntity<?> proxySessionRequest(@PathVariable String sessionId, HttpServletRequest request) {
